...
import { deleteUser_ByAdmin, login, register, updateUserProfile, userProfile, userProfile_ByAdmin, usersList_ByAdmin } from "../controllers/authController.js"
...
routerAuth.delete("/admin/users/:id", verifyToken, verifyAdmin, deleteUser_ByAdmin)
